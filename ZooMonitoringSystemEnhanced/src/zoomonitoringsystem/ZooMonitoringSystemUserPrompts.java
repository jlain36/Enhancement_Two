...
public class ZooMonitoringSystemUserPrompts {
    ...
    private String sectionHeader8;
    private String sectionHeader9;
    ...
    public ZooMonitoringSystemUserPrompts() {
        ...
        this.userPrompt5 = "Enter a valid option( 1 to 7): ";
        ...
        this.sectionHeader5 = "Animal - Gorilla";
        this.sectionHeader6 = "Animal - Rhino";
        this.sectionHeader7 = "Habitat - Penguin";
        this.sectionHeader8 = "Habitat - Bird";
        this.sectionHeader9 = "Habitat - Aquarium";
    }
    ...
    public ZooMonitoringSystemUserPrompts(String userPrompt1, String userPrompt2, String userPrompt3,
            ...
            String sectionHeader4, String sectionHeader5, String sectionHeader6, String sectionHeader7, String sectionHeader8, String sectionHeader9) {
    ...
    public String getSectionHeader8(){
        return sectionHeader8;
    }
    
    public void setSectionHeader8(String sectionHeader8){
        this.sectionHeader8 = sectionHeader8;
    }
    
    public String getSectionHeader9(){
        return sectionHeader9;
    }
    
    public void setSectionHeader9(String sectionHeader9){
        this.sectionHeader9 = sectionHeader9;
    }
}
